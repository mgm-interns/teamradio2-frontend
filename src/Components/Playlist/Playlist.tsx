    ...
    if (!nowPlaying) {
      ...
      const song1 = {
        ...
        creator: {
          name: 'Thuy Tien',
          username: 'ThuyTien',
          avatar_url: 'https://lh5.googleusercontent.com/-wEPw9I56XVk/AAAAAAAAAAI/AAAAAAAAFFo/DLzRP_EyOxk/s96-c/photo.jpg'
        },
        duration: '20:06',
        willBeSkipped: false,
        message: 'Hello',
      ...
      const song2 = {
        ...
        creator: {
          name: 'Thuy Tien',
          username: 'ThuyTien',
          avatar_url: 'https://res.cloudinary.com/cocacode2/image/upload/v1517992692/hhunvpjq7ogvoehk7flk.png'
        },
        duration: '20:06',
        willBeSkipped: true,
        message: 'Iloveyou',
        ...
        <Card className="play-list">
          <FlipMoveList
            ...
            {playlist.map((song, index) => (
              <ItemPlaylist key={song.song_id || index} {...song} upVote={() => this.upVote()}

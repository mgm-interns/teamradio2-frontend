...
const FormWrapper = withFormik<any, FormValues>({
  ...
  validate: (values: FormValues) => {
    ...
    const {required, validEmail, validUsername, validDisplayName, minLength6, matchPassword} = Rules;
    const displayNameValidator = new Validator("Display name", displayName, [required, validDisplayName]);
